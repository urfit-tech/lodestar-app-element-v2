import { invariant as l, newInvariantError as h } from "./index.es72.js";
import "./index.es73.js";
import { Observable as i } from "./index.es49.js";
import "./index.es50.js";
import { createOperation as q } from "./index.es96.js";
import { transformOperation as w } from "./index.es97.js";
import { validateOperation as g } from "./index.es98.js";
function m(t, r) {
  return r ? r(t) : i.of();
}
function s(t) {
