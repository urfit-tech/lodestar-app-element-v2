...
export const AuthProvider = ({ appId, children }) => {
    ...
    return (_jsx(AuthContext.Provider, { value: {
            ...
            currentUserRole: payload?.role || 'anonymous',
            ...
            currentMember,
            permissions: payload?.permissions?.reduce((accumulator, currentValue) => {
                accumulator[currentValue] = true;
                return accumulator;
            }, {}) || {},
            refreshToken,
            register: async (data) => Axios.post(`${process.env.NEXT_PUBLIC_API_BASE_ROOT}/auth/register`, {
